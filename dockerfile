# .NET Core SDK
FROM mcr.microsoft.com/dotnet/core/sdk:3.1.301-alpine AS dotnetcore-sdk
...
# Angular
FROM node:14.4.0-alpine AS angular-build
...
FROM mcr.microsoft.com/dotnet/core/aspnet:3.1.5-alpine AS aspnetcore-runtime
